...
const ICONS = {
  ...
  icon5: (color = "#9CA3AF") => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="12" cy="12" r="10" fill={color} />
      <polygon points="12,7 13.5,10.5 17.5,10.5 14,13 15.5,17 12,14.5 8.5,17 10,13 6.5,10.5 10.5,10.5" fill="#FFF" />
    </svg>
  ),
};
      ...
      <s-grid gridTemplateColumns="1.5fr 1fr" gap="base" alignItems="start">
                  ...
                  <s-stack direction="inline" gap="base" alignment="center">
                    <button
                      ...
                      style={{
                        ...
                        border: creditIcon === "icon1" ? "2px solid #000" : "1px solid #E4E8EC",
                        borderRadius: "8px",
                        backgroundColor: "#FFF",
                        cursor: "pointer",
                      }}
                    ...
                    <button
                      ...
                      style={{
                        ...
                        alignItems: "center",
                        justifyContent: "center",
                        border: creditIcon === "icon2" ? "2px solid #000" : "1px solid #E4E8EC",
                        borderRadius: "8px",
                        backgroundColor: "#FFF",
                        cursor: "pointer",
                      }}
                    ...
                    <button
                      ...
                      style={{
                        ...
                        alignItems: "center",
                        justifyContent: "center",
                        border: creditIcon === "icon3" ? "2px solid #000" : "1px solid #E4E8EC",
                        borderRadius: "8px",
                        backgroundColor: "#FFF",
                        cursor: "pointer",
                      }}
                    ...
                    <button
                      ...
                      style={{
                        ...
                        alignItems: "center",
                        justifyContent: "center",
                        border: creditIcon === "icon4" ? "2px solid #000" : "1px solid #E4E8EC",
                        borderRadius: "8px",
                        backgroundColor: "#FFF",
                        cursor: "pointer",
                      }}
        ...
        <s-stack direction="block" gap="base">
          <s-stack direction="inline" alignment="center">
            ...
            <s-box flex="1" />
            <s-select value={previewPage} onInput={(e) => setPreviewPage(e.target.value)}>
                ...
                <s-stack gap="base" style={{ width: "100%", flex: 1, display: "flex", flexDirection: "column", gap: "20px" }}>
                  ...
                  <s-stack direction="inline" gap="base" alignment="center">
                    <img
                      ...
                      alt="Example T-Shirt"
                      style={{ width: "48px", height: "48px", objectFit: "cover", borderRadius: "6px", border: "1px solid #E4E8EC" }}
                    />
                  ...
                  <div style={{ backgroundColor: bgColor, color: textColor, padding: "10px", borderRadius: "8px", border: "1px solid rgba(0,0,0,0.08)", display: "flex", alignItems: "center", gap: "8px", textAlign: "left" }}>
                    {renderBannerIcon()}
                    <div style={{ display: "flex", flexDirection: "column", gap: "2px", flex: 1 }}>
                      <p style={{ margin: 0, fontSize: "13px", fontWeight: "600", lineHeight: "1.4", color: "inherit" }}>
                        You will get <strong style={{ fontWeight: "800", color: "inherit" }}>Rs. 3.75</strong> store credit after this purchase.
                      </p>
                      {!hideWatermark && (
                  ...
                  <s-box paddingBlockStart="4" style={{ marginTop: "auto" }}>
                    <s-button variant="primary" block>Checkout</s-button>
                  </s-box>
                </s-stack>
              )}
              ...
              {previewPage === "product" && (
                <s-stack gap="base" style={{ width: "100%", flex: 1, display: "flex", flexDirection: "column", gap: "16px" }}>
                  <img
                    src="https://cdn.shopify.com/s/files/1/0963/4349/0932/files/tshirts_100x100.jpg?v=1765864990"
                    alt="Example T-Shirt"
                    style={{ width: "100%", height: "176px", objectFit: "cover", borderRadius: "8px", border: "1px solid #E4E8EC" }}
                  />
                  <s-stack direction="block" gap="none">
                  ...
                  {/* Store Credit Live Banner */}
                  <div style={{ backgroundColor: bgColor, color: textColor, padding: "16px", borderRadius: "8px", border: "1px solid rgba(0,0,0,0.08)", display: "flex", alignItems: "center", gap: "12px", textAlign: "left" }}>
                    {renderBannerIcon()}
                    <div style={{ display: "flex", flexDirection: "column", gap: "2px", flex: 1 }}>
                      <p style={{ margin: 0, fontSize: "13px", fontWeight: "600", lineHeight: "1.4", color: "inherit" }}>
                        Receive <strong style={{ fontWeight: "800", color: "inherit" }}>Rs. 3.75</strong> store credit when purchasing each item.
                      </p>
                      {!hideWatermark && (
                        <p style={{ margin: "2px 0 0", fontSize: "10px", opacity: 0.7, lineHeight: "1", color: "inherit" }}>
                          Powered by <span style={{ textDecoration: "underline" }}>Getkoin.io</span>
                  ...
                  <s-box paddingBlockStart="4" style={{ marginTop: "auto" }}>
                    <s-button variant="primary" block>Add to cart</s-button>
                  </s-box>
                </s-stack>
              )}
            </s-box>
